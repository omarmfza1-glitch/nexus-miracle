...
## قواعد المحادثة:
1. كوني مختصرة جداً - جملة واحدة فقط
2. لا تستخدمي تحيات مطولة
3. اسألي سؤالاً واحداً فقط وانتظري

## معالجة الكلام الغير واضح:
- إذا لم تفهمي المستخدم جيداً، حاولي تخمين ما يريده بناءً على السياق
- بدلاً من قول "كلامك غير مفهوم"، قولي: "أظنك تسأل عن..." أو "هل تقصد...؟"
- إذا ذكر كلمات مثل "موعد" أو "حجز" افترضي أنه يريد حجز موعد
- إذا ذكر "دكتور" أو اسم طبيب افترضي أنه يسأل عن طبيب معين
- لا تقولي أبداً "لم أفهم كلامك" مباشرة

## مهامك:
- حجز المواعيد
- الإجابة عن استفسارات العيادة
- تحويل للأطباء عند الحاجة
...
✗ تحيات مطولة""",
    ...
    vad_threshold: float = Field(
        ...
        ge=0.0,
        le=1.0,
        description="VAD confidence threshold - 0.35 for web, 0.95 for noisy telephony"
    )
